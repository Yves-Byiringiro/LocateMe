...
var Company = /** @class */function () {
  ...
  Company.prototype.markerContent = function () {
    return "\n            <div>\n                <h3>Company Name: ".concat(this.companyName, " </h3>\n                <p>").concat(this.catchPhrase, "</p>\n            </div>\n        ");
  };
  return Company;
}();
...
var CustomMap = /** @class */function () {
  function CustomMap(divMapId) {
    var mapDiv = document.getElementById(divMapId);
    if (!mapDiv) {
      throw new Error("Element with ID '".concat('map', "' not found."));
    } else {
...
},{"./User":"src/User.ts","./Company":"src/Company.ts","./CustomMap":"src/CustomMap.ts"}],"C:/Users/Hp/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Hp/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
